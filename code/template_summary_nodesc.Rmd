...
temp <- special %>% 
  ...
  dplyr::select(priority_ranking, vessel, scientific_collection_short_title)
...
ft <- temp %>% 
  ...
  flextable::set_header_labels(x = .,
                               ...
                               "vessel" = "Vessel", 
                               "scientific_collection_short_title" = "Project Title") %>%
  # table aesthetics
  ...
  flextable::bold(x = ., bold = TRUE, j = "scientific_collection_short_title", part = "body") %>% 
